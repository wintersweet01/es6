---
home: true
heroImage: https://i.ytimg.com/vi/ZJZfIw3P8No/maxresdefault.jpg
actionText: 起步 →
actionLink: /guide/
features:
- title: 目标群体
  details: 此教程为es6的基础教程，我们希望您有JavaScript基础，对于web开发有大概的了解。
- title: Vue 驱动
  details: 享用 Vue + webpack 开发环境，在 markdown 中使用 Vue 组件，并通过 Vue 开发自定义主题。
- title: 性能高效
  details: VuePress 将每个页面生成为预渲染的静态 HTML，每个页面加载之后，然后作为单页面应用程序(SPA)运行。
footer: MIT Licensed | Copyright © 2018-present Wintersweet
---
